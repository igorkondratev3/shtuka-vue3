<script setup>
  ...
  import { drawArrowRight, goToNextLesson } from './functions.js';
...
<template>
  <div
    class="footer__button button button_border"
    ref="nextLesson"
    @click="goToNextLesson(storeLessonNum, storeLessonInformation)"
  >
    <canvas
      class="button__arrow"
      ref="arrowRight"
